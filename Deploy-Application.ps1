...
Try {
	...
	[string]$appName = 'ArcGIS Pro Patch'
	[string]$appVersion = '3.0.1'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.1'
	[string]$appScriptDate = '09/19/2022'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		If(Get-InstalledApplication -ProductCode '{FE78CD1B-4B17-4634-BBF7-3A597FFFAA69}'){
			$exitCode = Execute-MSP -Path "$dirFiles\ArcGIS_Pro_301_182232.msp"
			If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
		}
		Else{
			Write-Log -Message "ArcGIS base app not detected." -Source 'Installation' -LogType 'CMTrace'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'arcmap, ArcGISPro, arcglobe, arcscene, arcgisadmin, arccatalog' -CloseAppsCountdown 60
		...
		Write-Log -Message "Attempting uninstall patch..." -Source 'Installation' -LogType 'CMTrace'
		$exitCode = Execute-Process -Path "msiexec.exe" -Parameters "/i {FE78CD1B-4B17-4634-BBF7-3A597FFFAA69} MSIPATCHREMOVE={8F743BC6-7D74-489C-ABF9-5769CF6343C6} /qb /norestart /log $Env:windir\Logs\Software\ArcGISPro3.0.1-patch-uninstall.log" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUjJtwXos41ty47xSxn12cQVpr
# wXygghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFOpLuicm5oh9Mbck/LkhMAMniudcMA0GCSqGSIb3DQEBAQUABIIBgD+em9Yd
# EioiRArYQZLWNZyKwbH3ms5ApA+UzLSJMT7OoPcL19BsrC5yEB2EszRmYkVuSQiJ
# j56uSyqEC1dBk7jqpVyqc91gZ5jpvZ/UZRyTV+dV7s8Cd72qAy2QauSTWFDuKjGd
# cXk1fh2bxK/I7E/HDA/RFY2fR/qLf57vkXxnwhHAjLtMsvlta+KxOm10WlyFT0/W
# 82AIkpnCl5VlkYNFjF7yXW/lEsABgEvmoYlwr8zzxAZVouoMEh3mnGY7rRaN4wvg
# yuoepGKS4Ff/xIHp4mGASJZ8rbtMn//QSqe3RnIg549x5rV0STeTHlNjLEORwFz4
# 3yAgbHhkKpCYeUVk/m/9KKaPRu6BR//jRC6ghNaNcD+ELyCmuUDS3cB+bqTPye1M
# akw+wupAwQAnCu75IJ6wkmtcmt9jqnmGqP/YrNs9rdvntPXP2YdLj6G3pTn3IOxI
# EbS+LOzdcSiOOPytNG0bx7jnng4Pqt8L6MUgeNL7gYA6RbUB+gsNKEudjA==
